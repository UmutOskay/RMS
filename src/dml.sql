...
('S017812','Sefa Yapici','sefa.yapici@ozu.edu.tr','X0CoaE53B76fvULQV+QmWg==',0,0,3), 		  	 /* password is admin1234 */
('S017813','Umut Oskay','umut.oskay@ozu.edu.tr','sAXmnJilrW0H7Rsd4z55CQ==',0,0,3),                       /* password is user1234 */
('S017815','Hasan Umut Suluhan','umut.suluhan@ozu.edu.tr','rirmgP/zz+wigZDYoqkOWw==',0,0,3),             /* password is user2234 */
('S017819','Selami Karakaş','selami.karakas@ozu.edu.tr','ems/MnrzZbSMbThDcnZmvQ==',0,0,3),		 /* password is user3234 */
('F000034','Mehmet Ali Alakurt','tefa.yapici@ozu.edu.tr','3ZdUuD+XkU7zp+z2i2dKKg==',1,0,3);              /* password is user4234 */
