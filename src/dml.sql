...
('S017812','Sefa Yapici','sefa.yapici@ozu.edu.tr','dNKiZG8N3skhsdHA4SHynQ==',0,0,3), 		  	 /* password is admin1234 */
...
('F000034','Mehmet Ali Alakurt','tefa.yapici@ozu.edu.tr','0jCbxiFtRl4B6wCrlw4G1Q==',1,0,3);              /* password is user4234 */
